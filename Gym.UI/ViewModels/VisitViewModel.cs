...
namespace Gym.UI.ViewModels
{
    ...
    private readonly IReportService _reportService;
        ...
        public VisitViewModel(IUnitofWork unitOfWork, IMapper mapper, ILocalizationService localizationService, IDialogService dialog, IReportService reportService) 
        ...
        [RelayCommand]
        private async Task ExportVisitsReport()
        {
            try
            {
                IsBusy = true;
                var filePath = await _reportService.ExportVisitsReportAsync();
