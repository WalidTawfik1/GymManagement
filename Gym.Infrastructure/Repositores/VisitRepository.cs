...
namespace Gym.Infrastructure.Repositores
{
    public class VisitRepository : GenericRepository<Visit>, IVisitRepository
    {
        ...
        public async Task<VisitResponseDTO?> AddVisitAsync(int traineeId)
        {
            ...
            return await strategy.ExecuteAsync(async () =>
            {
                ...
                try
                {
                    ...
                    if ((activeMembership.MembershipType == "8 حصص" || activeMembership.MembershipType == "8 Sessions" || activeMembership.MembershipType == "12 حصة" || activeMembership.MembershipType == "12 Sessions" || activeMembership.MembershipType == "حصة واحدة" || activeMembership.MembershipType == "Single Session") && activeMembership.RemainingSessions.HasValue)
                    {
        ...
        public async Task<bool> DecrementRemainingSessionsAsync(int traineeId, bool saveChanges = true)
        {
            ...
            if ((membership.MembershipType == "8 حصص" || membership.MembershipType == "8 Sessions" || membership.MembershipType == "12 حصة" || membership.MembershipType == "12 Sessions" || membership.MembershipType == "حصة واحدة" || membership.MembershipType == "Single Session")  && membership.RemainingSessions.HasValue)
            {
        ...
        public async Task<bool> DeleteVisitAndRestoreSessionAsync(int visitId)
        {
            ...
            var membership = await _context.Memberships
                .Where(m => m.TraineeId == visit.TraineeId && !m.IsDeleted && 
                           (m.MembershipType == "8 حصص" || m.MembershipType == "8 Sessions" || m.MembershipType == "12 حصة" || m.MembershipType == "12 Sessions" || m.MembershipType == "حصة واحدة" || m.MembershipType == "Single Session"))
